CREATE TABLE `mq_consumer_log` (
  ...
  `state` INT(10) DEFAULT NULL COMMENT 'state (1-to be compensated, 2-compensation completed, -1 others)',
  ...
  `app_name` VARCHAR(256) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'consumer app name',
...
CREATE TABLE `mq_send_fail_log` (
  ...
  `send_bean_name` VARCHAR(256) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'sender bean name',
  `retry` INT(10) DEFAULT NULL COMMENT 'number of retries',
  `state` INT(10) DEFAULT NULL COMMENT 'state (1-to be compensated, 2-compensation completed, -1 others)',
